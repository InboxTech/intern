      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <form className="bg-white rounded-lg shadow-lg p-6 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
            ...
            <button
              type="button"
              onClick={handleSwap}
              className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 transition mt-6"
            >
            ...
            <div className="flex-1">
              <label className="block text-black mb-1" htmlFor="options">Flight Class</label>
              <select id="options" name="options" className="w-full p-3 border rounded cursor-pointer">
       ...
       <section className="px-15 py-18 bg-white">
        ...
        <div className="flex justify-center space-x-6 mt-5 mb-8 relative">
          <button className="bg-[#031B3D] text-white px-30 py-3 rounded-lg flex items-center space-x-2 shadow-md cursor-pointer"
        ...
        <div className="relative bg-gray-200 rounded-2xl overflow-hidden shadow-lg">
          ...
          <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center px-6 text-white bg-black/50">
            ...
            <button className="w-30 mt-4 bg-white text-black rounded-xl font-semibold shadow-md hover:bg-gray-500 cursor-pointer">
              How it works
            </button>
          </div>
